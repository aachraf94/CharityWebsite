...
<>
<a href="#" class="absolute top-0 left-0 mt-2 sm:mt-4 md:mt-4 lg:mt-4 xl:mt-4 ml-2 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-10">
...
<div className="bg-blue-400 h-screen flex  justify-center items-center">
  ...
  <h2 className="text-center text-yellow-300 text-4xl font-nohemi mt-4 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12">Compte</h2>

    <div className="bg-red   rounded-lg px-4 py-6 mt-4 w-full sm:w-5/6 md:w-1/2 lg:w-2/3 xl:w-4/5 ">
      <div className='flex flex-row justify-between ' >
      <img src={frm} width={64} className='sm:-mt-1 md:-mt-2 lg:-mt-1 xl:-mt-1'  />

      <h4 className="text-center text-white text-xl font-nohemi  xl:mt-3  ">Supprimer l'image</h4>
      <label htmlFor="file-input" className="bg-red-500 p-4 rounded-full cursor-pointer">
          <AiOutlineMinus  size={32} color="white" />
        </label>
      ...
      <div className="relative w-full mb-4 flex justify-between items-center ">
        <input
          className="w-full h-8 bg-transparent border-b-2 mt-6 border-gray-300 focus:outline-none focus:border-blue-500 focus:text-black"
          type="text"
          placeholder=""
          id="name"
          required
    ...
    <div class="flex flex-col 4 justify-center items-center md:flex-row md:justify-center md:items-center p-4 md:p-8 gap-4 md:gap-8 w-full md:w-auto h-auto md:h-71 bg-gray-800 md:bg-transparent shadow-lg md:shadow-none rounded-lg md:rounded-none">
      
    </div>
    
  </div>
  <button className="flex justify-center items-center bg-blue-500 rounded-xl shadow-md py-4 px-8 text-yellow-300 text-xl font-bold uppercase tracking-wide cursor-pointer hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 w-full sm:w-80 h-14 mt-4 ">
      sauvegarder 
      </button>
</div>
</div>
...
export default ModifierCompte2;