...
const Inscription = ({ event_id }) => {
  ...
  return (
    <>
      <div className=" top-[30%]  left-[40%] fixed translate-x-[-50%] translate-y-[-50%] flex justify-center items-center z-10" >
        <form onSubmit={formik.handleSubmit}>
          <div className=" border-box mx-auto flex flex-col justify-start items-center p-4 md:p-8 gap-4 text-red absolute w-auto sm:w-auto md:w-auto lg:w-auto xl:w-96 bg-[#f9dbbb88] shadow-lg rounded-lg">
            <h2 className="text-center  text-white text-4xl font-nohemi mt-4 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12">
              S'inscrire{" "}
            </h2>
