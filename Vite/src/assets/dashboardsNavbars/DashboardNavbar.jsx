  ...
  const handleLogout = async () => {
    ...
    return ( 
            <div className="w-64  flex flex-col bg-[#2E3840]">
                ...
                <div>
                    <div className='rounded-lg mt-4  flex flex-row items-center justify-start cursor-pointer p-1 bg-white '>
                        <img src={dash2} className='mr-2 w-4 ml-12 invert'></img>
                   <a href="/dashboard"><h1 className='text-xl text-black font-semibold cursor-pointer'>Dashboard</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                      ...
                      <a href="/utilisateurs"><h1 className='text-xl text-white font-semibold cursor-pointer'>Utilisateurs</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                        <img src={dash4} className='mr-2 w-4 ml-12 '></img>
                    <a href="/transactions" >   <h1 className='text-xl text-white font-semibold cursor-pointer'>Transactions</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                        <img src={dash5} className='mr-2 w-4 ml-12'></img>
                        <a href="/necessiteux">     <h1 className='text-xl text-white font-semibold cursor-pointer'>Nécessiteux</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                        <img src={dash6} className='mr-2 w-4 ml-12'></img>
                        <a href="/stock">      <h1 className='text-xl text-white font-semibold cursor-pointer'>Stock</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                        <img src={dash7} className='mr-2 w-4 ml-12'></img>
                    <a href="/participants">    <h1 className='text-xl text-white font-semibold cursor-pointer'>Participants</h1></a>
                    </div>
                    <div className='rounded-lg mt-16  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                     ...
                     <button onClick={()=>handleLogout()} >  <h1 className='text-xl text-white font-semibold cursor-pointer'>Déconnexion</h1></button>
                    </div>
                </div>
