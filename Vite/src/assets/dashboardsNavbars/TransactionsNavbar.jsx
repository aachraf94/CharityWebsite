            ...
            <div className="w-64  flex flex-col bg-[#2E3840]">
                ...
                <div>
                    ...
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-white '>
                        <img src={dash4} className='mr-2 w-4 ml-12 invert'></img>
                       <a href="/transactions">  <h1 className='text-xl text-black  font-semibold  '>Transactions</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                        <img src={dash5} className='mr-2 w-4 ml-12'></img>
                       <a href="/necessiteux"> <h1 className='text-xl text-white font-semibold '>Nécessiteux</h1></a>
                    </div>
                    <div className='rounded-lg mt-1  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                    ...
                    <div className='rounded-lg mt-16  flex flex-row items-center justify-start cursor-pointer p-1 bg-[#2E3840] '>
                     ...
                     <button  type="button" onClick={() =>handleLogout()}>   <h1 className='text-xl text-white font-semibold '>Déconnexion</h1></button>
                    </div>
                </div>
